...
const info = {
    ...
    workExpression: [
        ...
        {
            companyName: "普元信息技术股份有限公司",
            isPractice: false, //实习,
            startTime: "2020.12",
            endTime: "2021.08",
            workContent: [
                ` <li class="item-intro">对公司提供的UI设计图进行还原</li>`,
                `<li class="item-intro">与后端进行接口方面的对接,与问题解决</li>`,
                `<li class="item-intro">对公司的产品worksapce进行维护,及解决客户使用过程中出现的bug</li>`,
            ],
        },
    ],
    projectExpression: [
        {
            name: "国家管网行政服务webApp",
            description: "行政服务管理平台是用于公司内部管理信息发布,公司交流圈,以及各种用户申请,访客预约,信息登记以及审批的流程信息管理工具",
            list: [
                `<li class="item-intro">负责国家管网的行政管理服务平台</li>`,
                `<li class="item-intro">
                ...
                技术栈:
                <strong>Vue</strong
                >、<strong>Vuex</strong>、<strong>Vue-Router</strong>、<strong>Axios</strong>、<strong>CubeUI</strong>、<strong>ECharts</strong>、<strong
              >Webpack</strong
              >、<strong>Git</strong>
              </li>`,
            ],
        },
        {
            name: "中国联通流程应用中心",
            list: [
                `<li class="item-intro">对联通使用的公司产品worksapce进行维护(<strong>Vue</strong>)</li>`,
                `<li class="item-intro">负责应用中心的bug修复与代码合并(<strong>React</strong>)</li>`,
                `<li class="item-intro">通过天梯DevOps负责流程应用中心的发版,以及代码分支的管理</li>`,
                `<li class="item-intro">
                技术栈:
                <strong>Vue</strong
                >、<strong>Vuex</strong>、<strong>Vue-Router</strong>、<strong>React</strong>、<strong>Git</strong>、<strong>AntDesign</strong>
              </li>`,
            ],
        },
        {
            name: "中海油门户官网",
            list: [
                `<li class="item-intro">使用<Strong>Vue</Strong>+<Strong>ElementUI</Strong>对公司分派的项目进设计与编写</li>`,
                `<li class="item-intro">对接后端接口,与后端共同解决接口调用中出现的问题</li>`,
                `<li class="item-intro">
                技术栈:
                <strong>Vue</strong
                >、<strong>Vuex</strong>、<strong>Vue-Router</strong>、<strong>ElementUI</strong>
              </li>`,
            ],
        },
    ],
    openSourceProject: [
        {
            ...
            preview: "http://aliveui.dreamsakula.top/#/",
        ...
        },
        {
            ...
            description:
                " 使用Vue2 + TypeScript开发的一款本地记账本,实现了账单添加、账单编辑、账单统计等功能",
            list: [
                `<li class="item-intro">
                    本应用可以快速的实现记账功能,为满足日常需求开发
                  </li>`,
